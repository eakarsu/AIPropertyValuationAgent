...
const FEATURE_SLUG = 'no-watchlist-alerts-for-market-changes-in-sa';
const FEATURE_TITLE = 'No watch-list alerts for market changes in saved neighborhoods';
const PROJECT = 'AIPropertyValuationAgent';
